...
package {
	...
	public class FlxInputText extends FlxText {
		...
		static public const ONLY_DECIMALNUMERIC:uint 	= 3;
		static public const ONLY_ALPHANUMERIC:uint		= 4;
		static public const CUSTOM_FILTER:uint			= 5;
		...
		private function onTextChange(event:Event):void
		{
			...
			case ONLY_DECIMALNUMERIC:		pattern = /[^\-.0-9]*/g;		break;
