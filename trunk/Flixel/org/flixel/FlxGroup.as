package org.flixel
{
	...
	public class FlxGroup extends FlxObject
	{
		...
		/**
		 * checks if all the members are dead.
		 */
		public function allDead():Boolean
		{
			...
			{
				o = members[i] as FlxObject;
				if (!o.dead && !((o as Enemy).type.indexOf("i") != -1)) { return false; } //if not dead and not invincible
			}
			//FlxG.log("they all dead");
			return true;
		}
