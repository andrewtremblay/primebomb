package org.flixel
{
	...
	public class FlxG
	{
		...
		static protected var diff:Number;
		static protected var lvl:Number;
		...
		static public function setPauseState(_newPause:FlxGroup):void{
			_game.pause = _newPause;
		}
		...
		/**
		 * Set <code>diff</code> to the difficulty you want.
		 * 
		 * @default 1
		 */
		static public function getdiff():Number
		{
			return diff;
		}
		 ...
		 * @private
		 */
		static public function setdiff(_diff:Number):void
		{
			diff = _diff;
		}
		
		/**
		 * Set <code>lvl</code> to the level you want.
		 * 
		 * @default 1
		 */
		static public function getlvl():Number
		{
			return lvl;
		}
		...
		static public function setlvl(_lvl:Number):void
		{
			lvl = _lvl;
		}
